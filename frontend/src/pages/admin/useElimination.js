 ...
 * DUPLIQUÉ de `pages/evaluateur/useElimination.js` (même contenu) : l'élimination
 * s'ouvre à la fois depuis `CandidaturesSupervision.jsx` (ici) et
 * `FicheCandidat.jsx` (`pages/evaluateur/`) — pas de pont entre les deux arbres.
 *
