...
/**
 * Confirmation à motif obligatoire (Lot 8d-3) — utilisée pour le remplacement
 * (`Classement.jsx`) et l'élimination manuelle depuis la supervision
 * (`CandidaturesSupervision.jsx`). DUPLIQUÉE de
 * `pages/evaluateur/MotifConfirmDialog.jsx` (même contenu) : pas de pont entre
 * les deux arbres (garde de non-pont, symétrique depuis le 8d-1).
 *
