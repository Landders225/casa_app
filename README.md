...
> - **Lot 4** — espace évaluateur (rôles évaluateur/administrateur, backend seul) : **4a** consultation des dossiers affectés + vérification (nationalité, diplôme) déclenchant les critères éliminatoires évaluateur ; Resources évaluateur distinctes, aucune fuite vers le candidat. Toujours **aucun écran React**.
